...
if __name__ == "__main__": 
    ...
    torque_state_dict = torch.load(f"param/models/model_torque_controller_new.pt")
    ...
    new_weights = torch.mm(integ_weights, rate_state_dict['readout.weight'])
    ...
    new_weights = torch.mm(torque_state_dict['l1.synapse_ff.weight'], rate_state_dict['readout.weight'][[2, 3, 0, 1], :])
